 ...
 * @link      N/A 
 */
class ITwebexperts_Events_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('itwebexperts_events')->__('Uploaded image is not valid'));
            }
     ...
     *
     * @param ITwebexperts_Events_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(ITwebexperts_Events_Model_Events $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
